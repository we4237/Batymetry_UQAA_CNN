...
# print('MAPE: %f' % (mean_absolute_percentage_error(Y_XGtest, Ytest) * 100))
#
# print('='*21)
# dataset = np.load('500_depth0_3_UQAA.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_XGtest = regrXG.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth3_6_UQAA.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_XGtest = regrXG.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth6_9_UQAA.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_XGtest = regrXG.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth9__UQAA.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_XGtest = regrXG.predict(Xtest)
# print('测试集R^2: %f' % regrXG.score(Xtest, Ytest))
...
print('='*21)
dataset = np.load('500_depth0_3_noUQAA.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_XGtest = regrXG.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth3_6_noUQAA.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_XGtest = regrXG.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth6_9_noUQAA.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_XGtest = regrXG.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_XGtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth9__noUQAA.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_XGtest = regrXG.predict(Xtest)
print('测试集R^2: %f' % regrXG.score(Xtest, Ytest))
