...
#
# print('='*21)
# dataset = np.load('500_depth0_3_UQAA_stan.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_SVRtest = regrSVR.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth3_6_UQAA_stan.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_SVRtest = regrSVR.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth6_9_UQAA_stan.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_SVRtest = regrSVR.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
#
# print('='*21)
# dataset = np.load('500_depth9__UQAA_stan.npy')
# Xtest = dataset[:,:5]
# Ytest = dataset[:,5]
# Y_SVRtest = regrSVR.predict(Xtest)
# print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
Xtrain, Xtest, Ytrain, Ytest = train_test_split(b_dn, depth, test_size=0.1, random_state=0)
...
print('='*21)
dataset = np.load('500_depth0_3_noUQAA_stan.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_SVRtest = regrSVR.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth3_6_noUQAA_stan.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_SVRtest = regrSVR.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth6_9_noUQAA_stan.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_SVRtest = regrSVR.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
...
print('='*21)
dataset = np.load('500_depth9__noUQAA_stan.npy')
Xtest = dataset[:,:3]
Ytest = dataset[:,3]
Y_SVRtest = regrSVR.predict(Xtest)
print('RMSE: %f' % mean_squared_error(Y_SVRtest, Ytest) ** 0.5)
